...
import Marquee from "@/components/Marquee"; // Marquee bileşenini import ediyoruz
import "./globals.css";
        ...
        <header className="w-full border-b border-white/5 sticky top-0 bg-black/80 backdrop-blur-xl z-[100]">
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex flex-col md:flex-row items-center py-4 h-auto md:h-24 gap-6 md:gap-0">
              ...
              {/* LOGO - Masaüstünde sol tarafa sabitlendi */}
<div className="shrink-0 md:flex-1 md:flex md:justify-start">
  <Link href="/" className="flex items-center group relative">
    
    {/* LOGO ARKASI PARLAMA - Daha loş ve kontrollü bir aura */}
    ...
    {/* LOGO YANINDAKİ METİN - Punto küçültüldü ve daha zarif bir hale getirildi */}
    <div className="ml-3 hidden lg:block overflow-hidden leading-tight">
        ...
        {/* FOOTER */}
        <footer className="mt-12 md:mt-24 border-t border-white/5 py-16 bg-gradient-to-t from-blue-900/5 to-transparent">
